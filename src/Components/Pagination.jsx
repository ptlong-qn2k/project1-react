...
export default function PaginationControlled({ onChangeUid, page, perpage, limit, count, dataTotal, onChangePerPage }) {
    ...
    return (
        <div className="flex flex-row justify-between items-end w-full h-full m-auto ">
            <p className="w-[198px]h - [13px] text - [13px] cursor-pointer">
                        ...
                        <PaginationItem
                            components={{
                                next: (props) => (
                                    <div
                                        {...props}
                                        className="w-[55px] h-full flex flex-row justify-center items-center"
                                    >
                                        Next
                                    </div>
                                ),
                                previous: (props) => (
                                    <div {...props} className="w-[89px] flex flex-row justify-center items-center">
                                        Previous
                                    </div>
                                ),
                            }}
