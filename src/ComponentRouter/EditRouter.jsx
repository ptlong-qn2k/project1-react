            ...
            <div className='flex flex-col items-center'>
                <Box className="bg-white w-[600px] justify-center h-[450px] p-5 ">
                    ...
                    <form className='w-[500px] h-[200px] flex flex-col mb-[22px] mt-7 justify-between items-center '>
                        <label htmlFor="title" className='flex w-[500px] flex-row justify-between items-center'>title
                            <input type='text' id='title' value={dataEdit.title} name='title' onChange={getInput2} placeholder='Organization Name' className="bg-[#F1F1F1] w-[450px] h-[30px] text-xs pl-[10px] " />
                        </label>
                        <label htmlFor="" className='flex w-[500px] flex-row justify-between items-center'>sku
                            <input type='text' id='sku' value={dataEdit.sku} name='sku' onChange={getInput2} placeholder="Organization Name" className="bg-[#F1F1F1] w-[450px] h-[30px] text-xs pl-[10px]  " />
                        </label>
                        <label htmlFor="" className='flex w-[500px] flex-row justify-between items-center'>weight
                            <input type='text' id='weight' value={dataEdit.weight} name='weight' onChange={getInput2} placeholder="Organization Name" className="bg-[#F1F1F1] w-[450px] h-[30px] text-xs pl-[10px] " />
                        </label>
                        <label htmlFor="" className='flex w-[500px] flex-row justify-between items-center'>price
                            <input type='text' id='price' value={dataEdit.price} name='price' onChange={getInput2} placeholder="Organization Name" className="bg-[#F1F1F1] w-[450px] h-[30px] text-xs pl-[10px] " />
                        </label>
                        <div>
