...
const ModalDelete = ({ setOpen1, open1, idDelete }) => {
    ...
    return (
        ...
        >
            <Box sx={style} className="w-[378px] h-[234px] border border-solid flex flex-col m-auto relative top-[100px]">
                ...
                <div className="w-[203px] h-[26px] flex flex-row justify-between absolute left-[145px] top-[132px]">
                    <button onClick={() => setOpen1(false)} className="w-[99px] h-full text-sm bg-[#04474433] text-[#004744] flex items-center justify-center">Cancel</button>
